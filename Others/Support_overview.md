...
|---------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |---------------------------------------------- |
| <img src="media/DVS128.png" width="400"/>          | **DVS128** <br/><br/> A 128x128 DVS in a strong plastic case, with a USB 2.0 interface, CS-mount, tripod mount and  inter-camera synchronization pins.                                                                                                                        | http://www.inivation.com/support/dvs128       |
| <img src="media/DVS128_PAER.png" width="400"/>     | **DVS128_PAER** <br/><br/>  A CS-mount bare-board camera, with a 128x128 DVS and with parallel AER interface (Rome and CAVIAR standards).                                                                                                                                     | http://www.inivation.com/support/dvs128paer   |
