---
title: |
    []{#_e3vwvtbzvxdp .anchor}User Guide - eDVS4337 (embedded Dynamic Vision
    Sensor) and PushBot
---
...
![](media/image13.jpg){width="4.984375546806649in"
height="2.8676126421697288in"}

If you are confused about which device you have, please see the
[[support
overview]{.underline}](http://www.inilabs.com/support/overview). For
support for older eDVS prototypes see here:

[[https://wiki.lsr.ei.tum.de/nst/programming/edvsgettingstarted]{.underline}](https://wiki.lsr.ei.tum.de/nst/programming/edvsgettingstarted)

[[Specification]{.underline}](#specification)

> [[Board layout]{.underline}](#board-layout)

[[Getting started]{.underline}](#getting-started)

> [[Viewing and processing
> events]{.underline}](#viewing-and-processing-events)
>
> [[Biasing the DVS]{.underline}](#biasing-the-dvs)

[[Custom firmware
development]{.underline}](#custom-firmware-development)

> [[Firmware reprogramming]{.underline}](#firmware-reprogramming)
>
> [[Windows & MacOS X]{.underline}](#windows-macos-x)
>
> [[Step 1 - Communication]{.underline}](#step-1---communication)
>
> [[Step 2 - Erase]{.underline}](#step-2---erase)
>
> [[Step 3 - Hex File]{.underline}](#step-3---hex-file)
>
> [[Step 4 - Options]{.underline}](#step-4---options)
>
> [[Step 5 - Start]{.underline}](#step-5---start)
>
> [[Step 6 - Waiting]{.underline}](#step-6---waiting)
>
> [[Step 7 - Executing]{.underline}](#step-7---executing)
>
> [[Linux]{.underline}](#linux)
>
> [[Recovering from faulty
> firmware]{.underline}](#recovering-from-faulty-firmware)

[[Accessing the device
manually]{.underline}](#accessing-the-device-manually)

[[UART Protocol (PC-\>Board)]{.underline}](#uart-protocol-pc-board)

> [[Enabling / Disabling Data
> Streaming]{.underline}](#enabling-disabling-data-streaming)
>
> [[Event recording formats]{.underline}](#event-recording-formats)
>
> [[Streaming]{.underline}](#streaming)
>
> [[Recording]{.underline}](#recording)

[[Connectors]{.underline}](#connectors)

> [[All connectors on the board are this type (6 pin or 8
> pin):]{.underline}](#all-connectors-on-the-board-are-this-type-6-pin-or-8-pin)
>
> [[GPIO]{.underline}](#gpio)
>
> [[ADC]{.underline}](#adc)
>
> [[PWM Outputs]{.underline}](#pwm-outputs)
>
> [[SPI]{.underline}](#spi)
>
> [[UART0 (Slave)]{.underline}](#uart0-slave)
>
> [[UART1 (Master)]{.underline}](#uart1-master)

[[Optional: WLAN module]{.underline}](#optional-wlan-module)

> [[Connecting the wlan module to PC via
> USB-\>UART]{.underline}](#connecting-the-wlan-module-to-pc-via-usb-uart)
>
> [[Configuring the WIFI network credentials on the module with putty
> (new ZentriOS wlan
> module)]{.underline}](#configuring-the-wifi-network-credentials-on-the-module-with-putty-new-zentrios-wlan-module)
>
> [[Configure the wlan module via tcp (the Telnet function on putty)
> after we get the mac address of\
> the module in the previous
> section]{.underline}](#configure-the-wlan-module-via-tcp-the-telnet-function-on-putty-after-we-get-the-mac-address-of-the-module-in-the-previous-section)
>
> [[Communicating with the pushbot via
> wifi]{.underline}](#communicating-with-the-pushbot-via-wifi)

[[Optional: PushBot]{.underline}](#optional-pushbot)
...
-   1 USB 2.0 FTDI virtual serial port, up to 12 Mbps (shared with
    > UART0).

-   2 UART connectors, up to 12 Mbps, hardware handshaking (one shared
    > with FTDI/USB).

-   1 SPI/SSI/Microwire interface (up to 25Mbit full duplex; 50Mbit
    > transmit only).

-   6 PWM digital output lines (0-2.8V).

-   4 PWM controlled power signals (for up to 2 independent
...
-   Field of view: default \~55deg (hor./ver.); optional lenses 20 -
    > 120deg.
...
![](media/image14.png){width="7.675565398075241in"
height="4.515625546806649in"}

**Back:**

![](media/image7.png){width="8.262956036745408in" height="4.508681102362205in"}
===============================================================================

**Board Dimensions:**

![](media/image8.png){width="5.8006955380577425in" height="3.776042213473316in"}
================================================================================
...
[[jAER user guide]{.underline}](http://www.inilabs.com/support/jaer).
...
FTDI's latest VCP drivers for FT232HL here:
[[http://www.ftdichip.com/Drivers/VCP.htm]{.underline}](http://www.ftdichip.com/Drivers/VCP.htm)
...
![jaer\_edvs\_menu.png](media/image11.png){width="6.5in"
height="4.25in"}
...
![jaer\_edvs\_ifacechooser.png](media/image15.png){width="6.5in"
...
[[https://github.com/inilabs/devices-bin/tree/master/firmware/eDVS4337]{.underline}](https://github.com/inilabs/devices-bin/tree/master/firmware/eDVS4337)
...
[[https://github.com/inilabs/devices-bin/tree/master/firmware/eDVS4337/Releases]{.underline}](https://github.com/inilabs/devices-bin/tree/master/firmware/eDVS4337/Releases)
...
manually]{.underline}](#accessing-the-device-manually)", below):
...
[[http://www.flashmagictool.com/]{.underline}](http://www.flashmagictool.com/).
...
[[http://www.windscooting.com/softy/mxli.html\#Latest]{.underline}](http://www.windscooting.com/softy/mxli.html#Latest)\
...
datasheet]{.underline}](http://cache.nxp.com/documents/data_sheet/LPC435X_3X_2X_1X.pdf?fpsp=1&WT_TYPE=Data%20Sheets&WT_VENDOR=FREESCALE&WT_FILE_FORMAT=pdf&WT_ASSET=Documentation&fileExt=.pdf).

On the PCB, this pin is pulled up to VCC through a pull-up resistor by
default, as can be seen here:

![image001.jpg](media/image16.jpg){width="7.470609142607174in"
...
![image002.jpg](media/image18.jpg){width="7.524305555555555in"
...
be downloaded
[[here]{.underline}](http://www.chiark.greenend.org.uk/~sgtatham/putty/download.html).
...
!P\[A,B,C\]\[0,1\]=\[%\]x - set timer channel width in microseconds \[%
0..100\]
...
bytes delta-timestamp (7 bits each)
...
+===================================+===================================+
| !E1 will result in data packets   | 1yyyyyyy.pxxxxxxx.1ttttttt        |
|                                   |                                   |
|                                   | (time stamp wrap-around after     |
|                                   | 2\^7 us = 128 us)                 |
|                                   |                                   |
|                                   | 1yyyyyyy.pxxxxxxx.0ttttttt.1ttttt |
|                                   | tt                                |
|                                   |                                   |
|                                   | (time stamp wrap-around after     |
|                                   | 2\^14 us = 16 384 =\~ 16 ms)      |
|                                   |                                   |
|                                   | 1yyyyyyy.pxxxxxxx.0ttttttt.0ttttt |
|                                   | tt.1ttttttt                       |
|                                   |                                   |
|                                   | (time stamp wrap-around after     |
|                                   | 2\^21 us = 2 097 152 us =\~ 2     |
|                                   | sec)                              |
|                                   |                                   |
|                                   | 1yyyyyyy.pxxxxxxx.0ttttttt.0ttttt |
|                                   | tt.0ttttttt.1ttttttt              |
|                                   |                                   |
|                                   | (time stamp wrap-around after     |
|                                   | 2\^28 us = 268 435 456 us =\~ 4.5 |
|                                   | min)                              |
+-----------------------------------+-----------------------------------+
| !E2 will result in data packets:  | 1yyyyyyy.pxxxxxxx.tttttttt.tttttt |
|                                   | tt\                               |
|                                   | (time stamp wrap-around after     |
|                                   | 2\^16 us = 65 535 us =\~ 65ms)    |
+-----------------------------------+-----------------------------------+
| !E3 will result in data packets:  | 1yyyyyyy.pxxxxxxx.tttttttt.tttttt |
|                                   | tt.tttttttt                       |
|                                   |                                   |
|                                   | (time stamp wrap-around after     |
|                                   | 2\^24 = 16 777 216 us =\~ 16 sec) |
+-----------------------------------+-----------------------------------+
| !E3 will result in data packets:  | 1yyyyyyy.pxxxxxxx.tttttttt.tttttt |
|                                   | tt.tttttttt.tttttttt              |
|                                   |                                   |
|                                   | (time stamp wrap-around after     |
|                                   | 2\^24 = 4 294 967 296 us =\~ 72   |
|                                   | min)                              |
+-----------------------------------+-----------------------------------+
...
[[http://de.farnell.com/te-connectivity-amp/7-188275-6/federleiste-smd-6pol/dp/1056234]{.underline}](http://de.farnell.com/te-connectivity-amp/7-188275-6/federleiste-smd-6pol/dp/1056234)

[[http://de.farnell.com/te-connectivity-amp/7-188275-8/federleiste-smd-8pol/dp/2399717]{.underline}](http://de.farnell.com/te-connectivity-amp/7-188275-8/federleiste-smd-8pol/dp/2399717)

If you want to connect to your custom device, consider acquiring some of
those cables:

[[http://de.farnell.com/te-connectivity-amp/1483351-2/micromatch-6-pol-150mm/dp/1056211]{.underline}](http://de.farnell.com/te-connectivity-amp/1483351-2/micromatch-6-pol-150mm/dp/1056211)

[[http://de.farnell.com/te-connectivity-amp/1483352-2/micromatch-8-pol-150mm/dp/1056214]{.underline}](http://de.farnell.com/te-connectivity-amp/1483352-2/micromatch-8-pol-150mm/dp/1056214)
...
usual]{.underline}](#accessing-the-device-manually). The commands are
also the same, but certain ones, to enable or disable the motors for
example, will now work on the PushBot.

![pushbot\_front.jpg](media/image17.jpg){width="5.223958880139983in"
