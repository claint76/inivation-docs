...
| --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------- |
| Standard Event Display            | With this method, events are displayed in a 2 dimensional area. This is the default method of display.                                                                                                                                                          | <img src="media/jaer_AEViewer_SED.png" width="200" />                            |
| (unset method)                    | This is a placeholder for a future, unimplemented display method. Currently, it will display a blank space.                                                                                                                                                     |                                                                                  |
| Space Time Event Display          | With this method, events are displayed in an area with 3 axes: x, y and t (time). You can rotate the view on the origin of the axes by holding the mouse button down on the view and moving the mouse around. Green events are older, and red events are newer. | <img src="media/jaer_AEViewer_STED.png" width="200" />                           |
| Space Time Rolling Event Display  | Same as the Space TIme Event Display method above, with the origin placed differently, and less computationally expensive. Blue events are newer, green events are older.                                                                                       | <img src="media/jaer_AEViewer_STRED.png" width="200" />                          |
...
| <img src="media/jaer_AEViewer_rec_data_play_forw.png" width="40" />                                                           | Play forwards             | play the file from beginning to end                                                                                                                         |
| <img src="media/jaer_AEViewer_red_data_reverse.png" width="40" />                                                             | Reverse Play              | Reverse the direction of playback                                                                                                                           |
| <img src="media/jaer_AEViewer_red_data_back.png" width="40" />                                                                | Play backwards            | Play the file from end to beginning                                                                                                                         |
| <img src="media/jaer_AEViewer_red_data_faster.png" width="40" />                                                              | Faster                    | Increase the speed of playback                                                                                                                              |
| <img src="media/jaer_AEViewer_red_data_slower.png" width="40" />                                                              | Slower                    | Decrease the speed of playback                                                                                                                              |
| <img src="media/jaer_AEViewer_red_data_step_forw.png" width="40" />                                                           | Step Forwards             | Plays a single frame at a time, from beginning to end                                                                                                       |
| <img src="media/jaer_AEViewer_red_data_step_back.png" width="40" />                                                           | Step Backwards            | Plays a single frame at a time, from end to beginning                                                                                                       |
| <img src="media/jaer_AEViewer_red_data_rewind.png" width="40" />                                                              | Rewind                    | Move playback position to the beginning of the log file                                                                                                     |
| <img src="media/jaer_AEViewer_red_data_clear_mark.png" width="40" />                                                          | Clears IN and OUT markers | Clear both markers placed on the log playback                                                                                                               |
| <img src="media/jaer_AEViewer_red_data_in_mark.png" width="40" />                                                             | Marks IN marker           | Place a marker at the current position of playback, from which the playback will always start playing from, instead of the beginning of the log             |
| <img src="media/jaer_AEViewer_red_data_out_mark.png" width="40" />                                                            | Marks OUT marker          | Place a marker at the current position of playback, up to which the playback will always end playing at, instead of the end of the log                      |
| <img src="media/jaer_AEViewer_red_data_loop.png" width="40" />                                                                | Loop Play                 | Toggles whether playback stops at the end of the log (or position of the OUT marker), or runs infinitely from the beginning (or position of the IN marker). |
